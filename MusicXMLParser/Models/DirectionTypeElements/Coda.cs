...
{
    public class Coda : IDirectionTypeElement, IEquatable<Coda>
    {
        ...
        public Coda(string? color = null, double? defaultX = null, double? defaultY = null, string? fontFamily = null,
        ...
        public override bool Equals(object? obj) => Equals(obj as Coda);

        public bool Equals(Coda? other) =>
            other != null &&
            Color == other.Color &&
        ...
        public override string ToString() =>
            $"Coda{{color: {Color}, defaultX: {DefaultX}, defaultY: {DefaultY}, fontFamily: {FontFamily}, fontSize: {FontSize}, fontStyle: {FontStyle}, fontWeight: {FontWeight}, halign: {Halign}, id: {Id}, relativeX: {RelativeX}, relativeY: {RelativeY}, smufl: {Smufl}, valign: {Valign}}}";
    }
}
